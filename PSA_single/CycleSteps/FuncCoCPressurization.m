...
%#codegen
%CoCPressurization: Calculate the change in state variables for CoC pres step
...
%   
%% Boundary Conditions
%   The boundary condtions for the CoC pressurization, corresponding to the
%   heavy product end of the column being opened and the the light product
%   end of the column being closed. A gas of known temperature and
%   composition being fed into the column through the heavy product end.
%   For the heavy product end, the following boundary condtions are used:
%   
%%  
...
%   
%%  
%   Weno mid point scheme is used to calculated the value at the boundary
%   between two volumes. Since the velocity shifts from negative to
%   positive, the WENO schemes under both velocities are calculated, and
%   then the point corresponding to the correct velocity is selected for
%   each node
%   
%%  
