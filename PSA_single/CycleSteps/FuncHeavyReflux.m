function derivatives = FuncHeavyReflux(~, state_vars, params, isotherm_params)
%#codegen
%HeavyReflux: Calculate the change in state variables for heavy reflux step
...
%   
%% Boundary Conditions
%   The boundary condtions for the heavy reflux, corresponding to both ends 
%   (light and heavy product end) of the column being opened. A gas of known
%   temperature and composition being fed into the column through the heavy
%   product end. For the heavy product end, the following boundary condtions
%   are used:
%   
%%  
%   $$ \bar{P} = 1+\Delta \quad $$  or  $$ \quad \bar{v} = 1 \quad | Z=0^- $$
%   
%   $$ y = y_{HR} \quad | Z=0^- $$
%   
%   $$ \bar{T} = \frac{T_{HR}}{T_{0}} \quad | Z=0^- $$
%   
%%  
%   It is noted that for the inlet pressure, this is either set as a constant
%   or the inlet velocity is set as a constant and the pressure changes to 
%   satisfy the velocity constraint at the inlet
